...
from EXTRUST.config import args
from EXTRUST.utils.data_util import *
from EXTRUST.frontdoor.HlDeconfounder import HLDeconfounder
...
flag_use_spacial_module = 's' if args.use_spacial_module else ''
flag_use_gru_module = 'g' if args.use_gru_module else ''
flag_use_interv_module = 'i' if args.use_interv_module else ''
flag_use_module = f"{flag_use_spacial_module}{flag_use_gru_module}{flag_use_interv_module}"
...
experiment_name = f"{time}_{args.dataset}_{flag_use_module}_{key_args}"
...
# Runner
from EXTRUST.runner import Runner
from EXTRUST.model import EADGNN
from EXTRUST.model import ECVAE
from EXTRUST.model import GRUEncoder
